class Admin::StationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @station.save
        format.html { redirect_to admin_station_path(@station), notice: 'Station was successfully created.' }
        format.json { render :show, status: :created, location: admin_station_path(@station) }
      else
